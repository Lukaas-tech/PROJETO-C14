...
function blueBalloon() {
  ...
  var blue = createSprite(0,Math.round(random(20, 370)), 10, 10); //DUVIDA:que numeros colocar
...
function greenBalloon() {
  //crieSprite para o balão
  var green = createSprite(0,Math.round(random(20, 370)), 10, 10);   //DUVIDA:que numeros colocar
  //adicioneImagem para o balão
...
function pinkBalloon() {
 //crieSprite para o balão
 var pink = createSprite(0,Math.round(random(20, 370)), 10, 10); //DUVIDA:que numeros colocar
  //adicioneImagem para o balão
